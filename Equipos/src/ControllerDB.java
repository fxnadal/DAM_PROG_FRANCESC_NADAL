...
public class ControllerDB {
	...
	public void leerEquipos(JComboBox listadoEquipos){
		...
		try{			
			...
			while(conjuntoResultados.next()){
				...
				listadoEquipos.addItem(conjuntoResultados.getObject("nombreEquipo"));
	...
	public void insertarEquipos(int x1,String s1,int x2,int x3, int x4,int x5,JComboBox listadoEquipos){
